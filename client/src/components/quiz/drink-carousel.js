...
const Carousel = () => {
  const items = [
    {
      image: "/images/drinks/wine.png",
      title: "紅酒",
      description: "情感豐富、重視深度連結、敏感細膩",
    },
    {
      image: "/images/drinks/precious-milk.png",
      title: "珍珠奶茶",
    ...
    {
      image: "/images/drinks/black-coffee.png",
      title: "黑咖啡",
    ...
    {
      image: "/images/drinks/match-latte.png",
      title: "抹茶拿鐵",
      description: "善解人意、追求平衡、具有包容力",
    },
    {
      image: "/images/drinks/whisky.png",
      title: "威士忌",
      description: "原則性強、獨立自主、不輕易妥協",
    },
    {
      image: "/images/drinks/milk-shake.png",
      title: "奶昔",
    ...
    {
      image: "/images/drinks/hot-cocoa.png",
      title: "熱可可",
